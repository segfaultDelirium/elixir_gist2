defmodule ElixirGist2.GistsTest do
  use ElixirGist2.DataCase

  alias ElixirGist2.Gists

  describe "gist" do
    alias ElixirGist2.Gists.Gist

    import ElixirGist2.GistsFixtures
  ...
  describe "saved_gist" do
    alias ElixirGist2.Gists.SavedGist
