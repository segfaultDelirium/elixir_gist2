defmodule ElixirGist2Web.Router do
  use ElixirGist2Web, :router

  import ElixirGist2Web.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ElixirGist2Web.Layouts, :root}
  ...
  # scope "/api", ElixirGist2Web do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:elixir_gist2, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ElixirGist2Web.Telemetry
  ...
  scope "/", ElixirGist2Web do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ElixirGist2Web.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", ElixirGist2Web do
    ...
    live_session :require_authenticated_user,
      on_mount: [{ElixirGist2Web.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", ElixirGist2Web do
    ...
    live_session :current_user,
      on_mount: [{ElixirGist2Web.UserAuth, :mount_current_user}] do
